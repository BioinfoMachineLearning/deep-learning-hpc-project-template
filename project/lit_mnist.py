...
class LitClassifier(pl.LightningModule):
    def __init__(self, hidden_dim=128, num_epochs: int = 5, lr=1e-4):
        ...
        self.train_auroc = tm.AUROC(average='weighted', num_classes=10)
        self.val_auroc = tm.AUROC(average='weighted', num_classes=10)
        self.test_auroc = tm.AUROC(average='weighted', num_classes=10)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log('val_auroc', self.train_auroc(y_hat, y))
        self.log('val_f1', self.train_f1(y_hat, y))
        return loss
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.log('test_auroc', self.train_auroc(y_hat, y))
        self.log('test_f1', self.train_f1(y_hat, y))
        return loss
...
def cli_main():
    ...
    template_ckpt_filename = 'LitClassifier-{epoch:02d}-{val_acc:.2f}'
